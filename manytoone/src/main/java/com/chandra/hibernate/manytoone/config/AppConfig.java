package com.chandra.hibernate.manytoone.config;
...
@ComponentScan("com.chandra.hibernate.manytoone")
...
public class AppConfig {
    ...
    public SessionFactory getSessionFactory(DataSource dataSource) {
        ...
        sessionBuilder.scanPackages(new String[] {"com.chandra.hibernate.manytoone.models"});
